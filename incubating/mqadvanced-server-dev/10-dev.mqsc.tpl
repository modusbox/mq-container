...
* Broadcast
DEFINE QLOCAL('FWAAS_DEV_BROADCAST') REPLACE
* Statement
DEFINE QLOCAL('FWAAS_DEV_STATEMENT') REPLACE
...
* Broadcast
DEFINE QLOCAL('FWAAS_STG_BROADCAST') REPLACE
* Statement
DEFINE QLOCAL('FWAAS_STG_STATEMENT') REPLACE
